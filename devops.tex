...
2016年毕业于西安电子科技大学，211和优势学科创新平台，未有工作经验。接受实习生标准薪资。原偏向运维开发，监控报警、日志记录等。
...
\begin{entrylist}
  \entry
    ...
    {内网私有云管理系统}
    {Python}
    { 完成数据库的表设计，ORM进行数据库操作，后期实现了简易的用户权限管理。前端Flask基础框架，虚拟化使用KVM/QEMU。内部模块包括基础配置管理，实例管理，服务器管理。IP分配通过Zerotier添加虚拟网卡,绑定域名至Cloudflare。基础存储方面，使用bcache方式。部分配置文件定期备份到s3上。
    \\}
